...
FROM index.docker.io/xmrto/aeon:dependencies1 as dependencies2
WORKDIR /data
...
FROM index.docker.io/xmrto/aeon:dependencies2 as dependencies3
WORKDIR /data
...
FROM index.docker.io/xmrto/aeon:dependencies3 as builder
WORKDIR /data
# BUILD_PATH:
